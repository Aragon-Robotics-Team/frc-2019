...
public abstract class RobotMap implements BetterSendable {
    ...
    public RGB rgb = getRGB();

    abstract RGB getRGB();

    public static abstract class RGB {
        public abstract Integer mainPort();

        public abstract Integer redPort();

        public abstract Integer greenPort();

        public abstract Integer bluePort();
    }
